...
try {
  ...
  // -------------------------------------------------------------------------
  await block('galleries are reachable', async () => {
  ...
  // -------------------------------------------------------------------------
  await block('sharing says something', async () => {
  ...
  // -------------------------------------------------------------------------
  await block('the friend code and its countdown', async () => {
      const { context, page } = await openApp(browser, 'runner7@mvmnt.test');
  ...
  // -------------------------------------------------------------------------
  await block('reporting confirms', async () => {
  ...
  // -------------------------------------------------------------------------
  await block('a failure offers a way back', async () => {
      const { context, page } = await openApp(browser, 'runner7@mvmnt.test');
  ...
  // -------------------------------------------------------------------------
  await block('organiser controls confirm', async () => {
  ...
  // -------------------------------------------------------------------------
  await block('the moderation queue can act', async () => {
      const { context, page } = await openConsole(browser);
  ...
  // -------------------------------------------------------------------------
  await block('attribution surfaces survive', async () => {
      const { context, page } = await openApp(browser, 'runner7@mvmnt.test');
